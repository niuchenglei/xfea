...
ReturnCode S_multi::generate_fea(const LogRecordInterface& record, FeaResultSet& fea_result_set) {
    ...
    return SingleSlotFeatureOp::emit_feature(_buf, fea_result_set);
}
